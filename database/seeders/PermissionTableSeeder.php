...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $permissions = [
            ...
            ['name' => 'show_requests_'.UnitType::SCHOOL->value, 'title' => 'نمایش درخواست های مساجد', 'guard_name' => 'web'],
            ['name' => 'edit_requests_'.UnitType::SCHOOL->value, 'title' => 'ویرایش درخواست های مساجد', 'guard_name' => 'web'],
            ['name' => 'delete_requests_'.UnitType::SCHOOL->value, 'title' => 'حذف درخواست های مساجد', 'guard_name' => 'web'],
            ['name' => 'export_requests_'.UnitType::SCHOOL->value, 'title' => 'خروجی درخواست های مساجد', 'guard_name' => 'web'],

            ['name' => 'show_requests_'.UnitType::CENTER->value, 'title' => 'نمایش درخواست های مساجد', 'guard_name' => 'web'],
            ['name' => 'edit_requests_'.UnitType::CENTER->value, 'title' => 'ویرایش درخواست های مساجد', 'guard_name' => 'web'],
            ['name' => 'delete_requests_'.UnitType::CENTER->value, 'title' => 'حذف درخواست های مساجد', 'guard_name' => 'web'],
            ['name' => 'export_requests_'.UnitType::CENTER->value, 'title' => 'خروجی درخواست های مساجد', 'guard_name' => 'web'],

            ['name' => 'show_requests_'.UnitType::UNIVERSITY->value, 'title' => 'نمایش درخواست های مساجد', 'guard_name' => 'web'],
            ['name' => 'edit_requests_'.UnitType::UNIVERSITY->value, 'title' => 'ویرایش درخواست های مساجد', 'guard_name' => 'web'],
            ['name' => 'delete_requests_'.UnitType::UNIVERSITY->value, 'title' => 'حذف درخواست های مساجد', 'guard_name' => 'web'],
            ['name' => 'export_requests_'.UnitType::UNIVERSITY->value, 'title' => 'خروجی درخواست های مساجد', 'guard_name' => 'web'],
