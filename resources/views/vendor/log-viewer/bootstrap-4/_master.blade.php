...
<head>
    ...
    {{-- Styles --}}
    <link rel="stylesheet" href="{{ asset('vendor/cdn/bootstrap/4.0.0/css/bootstrap.min.css') }}">
...
<body>
    ...
    {{-- Scripts --}}
    <script src="{{ asset('vendor/cdn/jquery/jquery-3.2.1.min.js') }}"></script>
    <script src="{{ asset('vendor/cdn/popper.js/1.12.9/umd/popper.min.js') }}"></script>
    <script src="{{ asset('vendor/cdn/bootstrap/4.0.0/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('vendor/cdn/chartjs/2.7.1/Chart.min.js') }}"></script>
