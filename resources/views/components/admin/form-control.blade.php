@props(['deleteAble' => false ,'chatAble' => false , 'deleteContent' , 'confirmContent' => 'ایجاد کردن' , 'link' => false, 'store' => true ,'title'=>false])
    ...
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex align-items-baseline flex-wrap ">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold my-1">{!!  $errors->any() ? '<span  class=\'text-danger\'>مشکلی پیش آمده</span>' : $title !!}</h5>
                <!--end::Page Title-->
            </div>
            <!--end::Page Heading-->
        </div>
