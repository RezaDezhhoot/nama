...
enum OperatorRole: string
{
    ...
    public function step(): array
    {
        return match ($this) {
            ...
            self::MOSQUE_CULTURAL_OFFICER => [RequestStep::APPROVAL_MOSQUE_CULTURAL_OFFICER , RequestStep::APPROVAL_MOSQUE_HEAD_COACH],
            self::AREA_INTERFACE => [RequestStep::APPROVAL_AREA_INTERFACE , RequestStep::APPROVAL_MOSQUE_CULTURAL_OFFICER ],
            self::EXECUTIVE_VICE_PRESIDENT_MOSQUES => [RequestStep::APPROVAL_EXECUTIVE_VICE_PRESIDENT_MOSQUES , RequestStep::APPROVAL_AREA_INTERFACE ],
            self::DEPUTY_FOR_PLANNING_AND_PROGRAMMING => [RequestStep::APPROVAL_DEPUTY_FOR_PLANNING_AND_PROGRAMMING , RequestStep::APPROVAL_EXECUTIVE_VICE_PRESIDENT_MOSQUES ],
            default => []
        };
    }
